...
public class InterfazEditarOferta {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InterfazEditarOferta window = new InterfazEditarOferta();
	...
	private void initialize() {
		...
		JLabel AñadirOfertas = new JLabel("Editar Oferta");
		...
		JLabel name = new JLabel("Vivienda que estas ofertando");
		...
		springLayout.putConstraint(SpringLayout.EAST, descripcionname, -20, SpringLayout.EAST, con);
