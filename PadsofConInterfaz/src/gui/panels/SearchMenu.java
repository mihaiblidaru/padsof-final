...
import gui.components.fx.FxRadioGroup;
...
public class SearchMenu extends JPanel {
	...
	public SearchMenu() {
		...
		/*
	     ...
	     Por que los componentes de swing son horiblemente feos
	    FxRadioGroup rg = new FxRadioGroup(180, 80, "Vivienda", "Vacacional");
	    
	    layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, rg, 0, SpringLayout.HORIZONTAL_CENTER, this);
