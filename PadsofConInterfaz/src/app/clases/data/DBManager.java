...
public class DBManager {
	...
	/**
	 * Pool de conexiones. Usado para minimizar el coste de crear una nueva
	 * conexion cada vez que se necesita un recurso de la base de datos.
	 */
	 ...
	 * 
	 * @throws PropertyVetoException ocurre cuando no se encuentra el driver necesario para las conexiones
	 */
	...
	/**
	 * Expresión regular usada para validar los datos leidos desde el
	 * fichero que contiene los datos de los clientes.
	 */
	 ...
	 * @throws SQLException ocurre cuando hay un error de conexion
	 */
	 ...
	 * @throws SQLException ocurre por un error de conexion o de sintaxis SQL
	 */
	public static boolean isDatabaseInitialized() throws SQLException {
		...
		String query = "SELECT COUNT(*) as num_tables from information_schema.tables where table_schema = 'mivacapiso' AND " + 
				"(TABLE_NAME  = '" + Tabla.CLIENTE + "' " + 
				"OR " + 
				"TABLE_NAME = '" + Tabla.OFERTA +"' " + 
				"OR " + 
				"TABLE_NAME = '" + Tabla.INMUEBLE + "' " + 
				"OR " + 
				"TABLE_NAME = '" + Tabla.CARACTERISTICA +"' " + 
				"OR " +
				"TABLE_NAME = '" + Tabla.OPINION +"' " + 
				"OR " + 
				"TABLE_NAME = '" + Tabla.RESERVA + "')"; 
	...
	/**
	 * Inicializa la base de datos. Ejecuta el script de creacion de tablas
	 * y carga los usuarios en la tabla de clientes.
	 * @throws SQLException ocurre cuando hay un error de conexion
	 */
	public static void initializeDatabase() throws SQLException {
		...
		try {	 
			...
			String sql = String.format("INSERT INTO %s (%s, %s, %s, %s, %s,%s) values(?, ?, ?, ?, ?,?);",
					Tabla.CLIENTE, Columna.CLIENTE_IDENTIFICADOR, Columna.CLIENTE_FULL_NAME,
					Columna.CLIENTE_PASSWORD, Columna.CLIENTE_CCARD, Columna.CLIENTE_ROL,
					Columna.CLIENTE_PROBLEMA_PAGOS);
	 ...
	 * 
	 * @param table Tabla que se quiere actualizar 
	 * @param column Columna que se quiere cambiar
	 * @param id Id de la fila que se quiere cambiar
	 * @param obj El nuevo dato a insertar
	 * @return true si los cambios se han realizado con exito o false en caso contrario
	 * @throws SQLException ocurre por un error de conexion
	 */
	public static boolean updateField(Tabla table, Columna column, int id, Object obj) throws SQLException {
		...
		Connection con = openDbConnection();
		PreparedStatement stmt = con.prepareStatement("UPDATE " + table + " SET " + column + " = ? " + "where id = " + id);
	...
	/**
	 * Da un valor a un atributo de una consulta preparada
	 * en funcion del tipo de la columna.
	 * 
	 * @param pstmt una consulta prepadada
	 * @param i indice del atributo que se quiere dar valor
	 * @param col columna para comparar los tipos
	 * @param obj el dato que se quiere insertar en la consulta
	 * @throws SQLException supone un error de conexion, sintaxis, etc.
	 */
	private static void setPreparedStatementAtribute(PreparedStatement pstmt, int i, Columna col, Object obj) throws SQLException {
	 ...
	 * @param t Tabla en la que se quiere insertar
	 * @param insertCols lista de las columnas que se van a insertar
	 * @param data array compuesto por los datos que se van a insertar 
