...
public class AniadirVivienda extends JPanel{

	private static final long serialVersionUID = -4230661380101910555L;

	private final Gui gui;
	
	private static AniadirVivienda instance = null; 
	
	public static AniadirVivienda getInstance(Gui gui) {
		if(instance == null) {
			return (instance = new AniadirVivienda(gui));
		}else {
			return instance;
		}
	}
	...
	private AniadirVivienda(Gui gui) {
		this.gui = gui;
		initialize();
	}
