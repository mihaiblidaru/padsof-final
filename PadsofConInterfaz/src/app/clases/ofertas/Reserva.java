...
public class Reserva {
	...
	*/
	...
	public static Reserva cargarReserva(int id) throws SQLException {
		...
		if(rs.next()) {
			LocalDate inicio = rs.getDate(Columna.RESERVA_FECHAINICIO.toString()).toLocalDate();/** Conseguimos la fecha de inicio de la reserva */
			Integer cliente = rs.getInt(Columna.RESERVA_CLIENTE.toString()); /** Conseguimos la id de demandante que hace la reserva */
	 ...
	 * @param idUsuario usuario que hace la reserva
	 * @param oferta oferta que reservamos
